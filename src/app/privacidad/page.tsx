...
export const metadata = buildMetadata({
  title: "Privacidad",
  description:
    "GeneCV no tiene cuentas ni base de datos: tu CV y tu foto se guardan solo en tu navegador. Qué datos ve la red de publicidad y cuáles no.",
  path: "/privacidad",
});

const jsonLd = breadcrumbJsonLd([{ name: "Privacidad", path: "/privacidad" }]);
