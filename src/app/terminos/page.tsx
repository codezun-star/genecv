...
export const metadata = buildMetadata({
  ...
  description: `Condiciones de uso de ${siteConfig.name}: qué puedes hacer con las plantillas y los PDF que generas, de quién es tu contenido y qué garantías ofrece el servicio.`,
  path: "/terminos",
});

const jsonLd = breadcrumbJsonLd([{ name: "Términos de uso", path: "/terminos" }]);
