...
/**
 * Tarjeta de un diseño premium.
 *
 * «Premium» aquí describe la maquetación, no un precio: se descargan igual que
 * las demás. Por eso la tarjeta no lleva candado ni desenfoque y enlaza al
 * editor como cualquier otra.
 */
    ...
    <>
      ...
      <section className="bg-canvas border-line border-t py-16">
        <Container>
          <Reveal className="max-w-2xl">
            <Badge tone="premium">Premium</Badge>
            <h2 className="mt-4 text-3xl font-bold">Diseños premium</h2>
            <p className="text-ink-soft mt-3 leading-relaxed">
              Maquetación más trabajada: barras laterales, líneas de tiempo,
              retículas editoriales y versiones compactas. Se descargan igual
              que las demás, sin coste, sin marca de agua y sin registro.
            </p>
          </Reveal>
