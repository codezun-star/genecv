  ...
  return [
    {
      ...
      a: `Sí. Las ${gratuitas + premium} plantillas, la vista previa y la exportación a PDF no cuestan nada y salen sin marca de agua, sin cuenta y sin tarjeta. Los ${premium} diseños premium se llaman así por la maquetación, no por el precio: también son gratis.`,
    },
    {
